...
- [x] T008 Regression verification: confirm unchanged comment-delivery behavior; `bun test plugins/github/`, `turbo check`, `bun run lint` green (file: plugins/github/server.test.ts) (depends on T003) (depends on T005) (depends on T006)
